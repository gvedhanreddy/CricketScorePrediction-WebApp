...
namespace CricketAnalysis.Data
{
    public class PlayerRepository:IPlayerRepository
    {
        ...
        public (string playerName, double averageRunsScored) GetAverageRunsScored(int Id)
        {
            ...
            return (player.PlayerName, (double)player.Runs / player.Inns);
        }
        ...
        public double GetAverageRunsScored(string playerName)
        {
            var player = _context.Player
        ...
        public (string playerName, double averageWicketsTaken) GetAverageWicketsTaken(int Id)
        {
            var player = _context.Player
                .Where(p => p.Id == Id)
            ...
            return (player.PlayerName, (double)player.Wickets / player.Inns);
        }
        ...
        public double GetAverageWicketsTaken(string playerName)
        {
            var player = _context.Player
                .Where(p => p.PlayerName == playerName && p.Inns != 0)
                .SingleOrDefault();
        ...
        /// <summary>
        /// Returns a list of top 10 players sorted by their strike rate
        /// </summary>
        /// <returns>List<Player></returns>
        ...
        public List<Player> GetMostHundredsscored()
        {
            ...
            return _context.Player.OrderByDescending(p => p.Hundred).Take(10).ToList();
        }
        ...
        public List<Player> GetMostFiftysscored()
        {
            ...
            return _context.Player.OrderByDescending(p => p.Fifty).Take(10).ToList();
        }
