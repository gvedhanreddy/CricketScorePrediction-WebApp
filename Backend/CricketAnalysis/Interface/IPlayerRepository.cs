...
namespace CricketAnalysis.Data
{
    public interface IPlayerRepository
    {
        ...
        (string playerName, double averageRunsScored) GetAverageRunsScored(int Id);

        double GetAverageRunsScored(string playerName);

        // Method to retrieve the average wickets taken by a player with the given ID
        (string playerName, double averageWicketsTaken) GetAverageWicketsTaken(int Id);

        double GetAverageWicketsTaken(string playerName);
